...
const specsOptions: swaggerJSDoc.Options = {
    swaggerDefinition: {
        ...
        tags: [
            ...
            { name: TAGS.GAME, description: 'Add game and user use for game' },
            { name: TAGS.GAME_HISTORY, description: 'Add game history' },
            {
                name: TAGS.PAYMENT,
                    ...
                    parameters: [
                        {
                            ...
                            required: true,
                            description:
                                'Create api with rolIds is list of role to use api',
                            example: {
                                name: '/api/test',
                                description: '',
                                moduleId: '',
